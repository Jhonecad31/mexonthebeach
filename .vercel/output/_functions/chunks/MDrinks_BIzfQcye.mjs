...
import 'piccolore';
import { a0 as renderComponent, u as renderTemplate, V as maybeRenderHead, W as addAttribute } from './entrypoint_-0SZX5Mn.mjs';
import { $ as $$BaseLayout } from './BaseLayout_BgTqOrz3.mjs';

const $$MDrinks = createComponent(($$result, $$props, $$slots) => {
  const menuImages = [
    "/menu-folder/menu-drinksp1.webp",
    "/menu-folder/menu-drinksp2.webp"
  ];
  const labels = {
