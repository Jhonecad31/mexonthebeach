...
import { $ as $$MakeReservation$1 } from './MakeReservation_BfOSB8y9.mjs';
...
}, "C:/mexonthebeach/src/pages/pt/make-reservation.astro", void 0);

const $$file = "C:/mexonthebeach/src/pages/pt/make-reservation.astro";
const $$url = "/pt/make-reservation";
